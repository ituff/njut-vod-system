	...
	<div class="wrapper-login">
		...
		<nav id="menu">
			<ul class="sf-menu">
				...
				<li class="current"><a href="register.aspx">注册</a></li>
			</ul>
		</nav>
        ...
        <div class="wrapper-login">
            ...
            x-webkit-speech MaxLength="20"></asp:TextBox>
					...
					<p>
						...
						<asp:TextBox id="password1" class="full" runat="server" TextMode="Password" 
                            MaxLength="30"></asp:TextBox>
					</p>
					<p>
						<label class="required" for="password">请重复</label><br/>
						<asp:TextBox id="password2" class="full" runat="server" TextMode="Password" 
                            MaxLength="30"></asp:TextBox>
					</p>
					<p>
						<label class="required" for="username">邮 箱:</label><br/>
						<asp:TextBox id="email" class="full" runat="server" x-webkit-speech 
                            MaxLength="50" ></asp:TextBox>
					</p>
					<p>
						<asp:Button ID="registerBtn" class="btn btn-green big" runat="server" Text="注册" 
